...
int main() {
  ...
  if (cid == 0) {
    ...
    idx_a  = (int *)snrt_l1alloc(sparsemv_l.M * sparsemv_l.N/32 * sizeof(int));
  ...
  if (cid == 0) {
    ...
    snrt_dma_start_1d(idx_a, sparsemv_packed_idx_A_dram, sparsemv_l.M * sparsemv_l.N/32 * sizeof(int));
    snrt_dma_wait_all();
  }
  ...
  int *idx_a_core = idx_a + sparsemv_l.N/32 * m_core * cid;
